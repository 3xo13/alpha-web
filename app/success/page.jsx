...
const success = () => {
  return (
    <div key={uuidv4()} className="screen h-screen flex flex-col items-center justify-center ">
      <h1 className="mb-5 capitalize text-5xl text-yellow-600/90">Thank you for your submission</h1>
      ...
      <Link key={uuidv4()} href="/">
        <button className="mb-5 capitalize text-2xl  bg-yellow-600 p-2 hove:bg-yellow-600/80 hover:text-gray-700 rounded-xl">Go back home</button>
      </Link>
    </div>
  )
}
